...
public class ResponseBodyController {
    ...
    public ResponseEntity<HelloData> responseBodyJsonV1() {
        HelloData helloData = new HelloData(); //바인딩 받을 객체를 만들어 두었었다.
        helloData.setUsername("userA");
        helloData.setAge(20);
        return new ResponseEntity<>(helloData, HttpStatus.OK);  //상태코드 수정도 가능
    }
    ...
    public HelloData responseBodyJsonV2() { //바인딩 객체를 반환값으로
